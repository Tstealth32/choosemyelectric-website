...
const COMMUNITY_SOLAR_PROGRAMS_BY_STATE = {
  CA: [
    {
      ...
      url: "https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/electric-costs/community-solar-green-tariff-program",
  ...
  CO: [
    {
      title: "Xcel Colorado Community Solar",
      description: "Official Xcel utility path for community solar garden participation with utility bill credits.",
      label: "Open Xcel program",
      url: "https://www.xcelenergy.com/staticfiles/xe-responsive/Programs%20and%20Rebates/Residential/CO-Solar-Rewards-Community-FAQ.pdf",
      utilities: "Xcel Energy",
      note: "Share availability and subscriber terms can change.",
    },
    {
  ...
  DC: [
    {
      ...
      url: "https://frontdoor.dc.gov/communitysolar",
      utilities: "Pepco",
  ...
  DE: [
    {
      ...
      url: "https://depsc.delaware.gov/customer-electric-choice/community-solar/",
  ...
  GA: [
    {
      ...
      url: "https://www.georgiapower.com/residential/save-money-and-energy/products-programs/residential-solar-solutions/community-solar/income-qualified.html",
  ...
  HI: [
    {
      title: "Hawaii Community-Based Renewable Energy",
      description: "Official Hawaii community-based renewable energy marketplace for off-site renewable subscriptions with utility-bill-credit treatment.",
      label: "Open Hawaii projects",
      url: "https://communityenergyhawaii.com/#/ViewProjects",
  ...
  MN: [
    {
      title: "Minnesota Community Solar Subscriber Options",
      description: "Official Minnesota consumer guidance for Xcel community solar gardens and subscriber organizations taking new customers.",
      label: "Open Minnesota subscriber list",
      url: "https://mn.gov/commerce/energy/consumer/energy-programs/community-solar-gardens/",
      utilities: "Xcel Energy",
      note: "Xcel-area program with subscriber-organization variability.",
    },
  ],
  NC: [
    {
  ...
  RI: [
    {
      title: "Rhode Island Community Solar Marketplace",
      description: "Official Rhode Island marketplace and energy-office guidance for joining a community solar project and receiving utility bill credits or discounts.",
      label: "Open Rhode Island marketplace",
      url: "https://www.risolarmarketplace.com/community-solar",
  ...
  SC: [
    {
      ...
      url: "https://www.dominionenergy.com/south-carolina/save-energy/solar/community-solar",
  ...
  VA: [
    {
      ...
      url: "https://www.dominionenergy.com/virginia/save-energy/solar/shared-solar",
